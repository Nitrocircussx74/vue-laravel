...
class feesBillsController extends Controller
{
    ...
    {
        return view('Backend.root-admin.receipt.receipt-form');
    }
    ...
    {
        $property = Property::find($property_id);
        return view('Backend.root-admin.receipt.import-receipt')->with('property', $property);
    }
    ...
    {
        $property = Property::find($property_id);
        return view('Backend.root-admin.receipt.import-expense')->with('property', $property);
    }
