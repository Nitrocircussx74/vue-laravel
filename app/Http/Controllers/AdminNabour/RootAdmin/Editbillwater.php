...
class Editbillwater extends Controller
{
    ...
    public function create()
    {
        ...
        $id = Request::input('id');
        if(!Request::ajax()) {
            return view('Backend.property_officer.list-bill-water')->with(compact('property_unit_array','list_month','month_label','id'));
        } else {
            return view('Backend.property_officer.list-element-water')->with(compact('property_unit_array','list_month','month_label','id'));
        }
    }
...
//dd($date_old_period);
        ...
        return view('Backend.property_officer.get-unit-edit-water-form')->with(compact('bill_data','list_month','id'));
    }
