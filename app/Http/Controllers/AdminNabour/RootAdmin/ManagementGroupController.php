...
class ManagementGroupController extends Controller
{
    ...
    public function groupList(Request $request)
    {
        ...
        if( $request->ajax() ) {
            return view('Backend.root-admin.management_group.group-list-page')->with(compact('pmg'));
        } else {
            return view('Backend.root-admin.management_group.group-list')->with(compact('pmg'));
        }
