...
use App\Http\Controllers\AdminNabour\PushNotificationController;
use Redirect;
use App\Http\Controllers\AdminNabour\GeneralFeesBillsReportController;
...
class PostController extends Controller {
	...
	public function feed () {
		...
		if(Request::ajax()) {
			return view('Backend.post_by_nabour.feed')->with(compact('posts','post_like','property','prop_list','provinces'));
		} else {
			...
			return view('Backend.post_by_nabour.feed_stream')->with(compact('posts','post_like','property','sticky_posts','sticky_post_like','prop_list','provinces'));
		}
	}
	...
	public function viewPost($id) {
		...
		$property = Property::find(Auth::user()->property_id);
		return view('Backend.post.view')->with(compact('post','post_like','property'));
	}
	...
	public function getform () {
		...
		return view('Backend.post_by_nabour.edit')->with(compact('post','property','prop_list','provinces','props_select','select_prop_id_arr','post_by_nabour_file'));
	}
