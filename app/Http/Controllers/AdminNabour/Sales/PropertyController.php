...
class PropertyController extends Controller {
    ...
    public function index(){
        ...
        return view('Backend.property_sale_demo.form-list')->with(compact('list_property','_lead'));
    }
    ...
    public function view ($id) {
        ...
        return view('Backend.property_sale_demo.view')->with(compact('property','provinces'));
    }
