...
class OfficerController extends Controller {
    ...
    public function officerList() {
        ...
        return view('officer.view-officer-list')->with(compact('officers','officer'));
    }
    ...
    public function addOfficer() {
        if (Request::isMethod('post')) {
            ...
            if($vu->fails()){
                return view('officer.officer-form')->withErrors($vu)->with(compact('officer'));
            }else {
                /*User::create([
                    'name' => $officer['name'],
                    'email' => $officer['email'],
    ...
    public function viewOfficer () {
        if(Request::ajax()) {
            ...
            return view('officer.view-officer')->with(compact('member'));
        }
    }
    ...
    public function getOfficer () {
        if(Request::ajax()) {
            ...
            return view('officer.officer-form-edit')->with(compact('officer'));
        }
    }
    ...
    public function editOfficer() {
        if (Request::isMethod('post')) {
            ...
            if($vu->fails()){
                ...
                return view('officer.officer-form-edit')->withErrors($vu)->with(compact('officer'));
            }else {
    ...
    public function deleteOfficerAccount($email){
        try{
